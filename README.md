...
Dockerfile for GoAWS

## Quick Start

Here's how to get started...

1. `git clone https://github.com/UnionPOS/docker-goaws` to pull down the repository
...
Please use the [issue tracker](https://github.com/UnionPOS/docker-goaws/issues) to report any bugs or file feature requests.
